...
gray <- read_excel("~/Bureau/MEGAFAUNA/DM/PuntWade2010.xlsx", 
...
#We an see that the prior and the posterior distribution of K are not completely the same. However, the convergence has been reached for K and it's look good. 
